...
public:
    ...
    void displayIntNum(unsigned long number, boolean leadingZeros);
    ...
    void DisplayDecNumNibble(uint16_t numberUpper, uint16_t numberLower, boolean leadingZeros);

    //TM1638 init and also print in Serial
    void TM1638_init();
